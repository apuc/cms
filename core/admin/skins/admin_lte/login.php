    ...
    <div class="login-box-body">
        ...
        <form action="" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" name="login" placeholder="Ваш логин или email">
        ...
        <a href="/<?= config_routing('admin-panel') ?>/registration" class="text-center">Регистрация</a>
